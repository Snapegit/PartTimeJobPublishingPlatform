		...
		<template v-if="showFlag">
			...
			<div :style='{"border":"0px solid #e9e9e9","width":"100%","padding":"0px","margin":"10px 0 0","borderRadius":"5px","background":"rgba(255,255,255,1)"}'>
				...
				@selection-change="selectionChangeHandler">
					...
					<!-- jianlifujian -->
					<!-- $column.hiden -->
					<el-table-column :resizable='true' :sortable='true' prop="jianlifujian" label="简历附件">
						<template slot-scope="scope">
							<el-button v-if="scope.row.jianlifujian" type="text" size="small" @click="download(scope.row.jianlifujian)">下载</el-button>
                            <span v-else >无</span>
						</template>
					</el-table-column>
					<!-- toudibeizhu -->
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="del" v-if="isAuth('toudixinxi','删除') " type="primary" @click="deleteHandler(scope.row.id )">
